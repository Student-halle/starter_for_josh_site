...
function load_my_scripts() {
  ...
  wp_enqueue_script( 'gsap-js', '<script src="https://cdnjs.clludflare.com/ajax/libs/gsap/3.9.0/ScrollTrigger.min.js"></script>', array(), false, true );
  wp_enqueue_script( 'gsap-js-custom', get_stylesheet_directory_uri() . '/script1.js', array(), false, true );

  wp_enqueue_script('lottie-player', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/gsap.min.js', array(), null, true);
